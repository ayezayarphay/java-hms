...
public class TemporyPaymentList implements Initializable {
	@FXML
	...
	public void load() {
		List<Treatment> list = treatmentService.getTemporaryData();
	...
	public void findAll() {
		...
		List<Treatment> list = treatmentService.findTemporaryData(treatment);
		table.getItems().clear();
		table.getItems().addAll(list);
	...
	public void showPaymentView() {
		...
		try {
			Parent root = FXMLLoader.load(getClass().getResource("TemporyPayment.fxml"));
